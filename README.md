...
## 📌 Assignment Week #3 - Unit 1 Player Control - Apply UI and Game FX
- Official course from Unity, Create with Code as you program your own exciting projects from scratch in C#.
- https://learn.unity.com/course/create-with-code?uv=6

- Add on to the Unit 1 sample game prototype with more Unity features. Audio effects, Lighting Effects, Title Screen, Settings Screen, UI Screen elements. Replace the car with another vehicle asset from the Unity Asset Store.
